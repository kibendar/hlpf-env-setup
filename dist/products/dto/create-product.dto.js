...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'iPhone 16', description: 'Product name', maxLength: 255 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 999.99, description: 'Price in UAH', minimum: 0.01 }),
    (0, class_validator_1.IsNumber)({ maxDecimalPlaces: 2 }),
    (0, class_validator_1.Min)(0.01),
    __metadata("design:type", Number)
], CreateProductDto.prototype, "price", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Flagship smartphone', description: 'Product description' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1, description: 'Category ID' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
