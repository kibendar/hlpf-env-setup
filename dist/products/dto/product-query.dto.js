...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1, description: 'Номер сторінки', default: 1 }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 10, description: 'Кількість елементів на сторінці (max 100)', default: 10 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.Min)(1),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'price', description: 'Поле для сортування', enum: ['name', 'price', 'stock', 'createdAt'], default: 'createdAt' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['name', 'price', 'stock', 'createdAt']),
    __metadata("design:type", String)
], ProductQueryDto.prototype, "sort", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'desc', description: 'Напрямок сортування', enum: ['asc', 'desc'], default: 'desc' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['asc', 'desc']),
    __metadata("design:type", String)
], ProductQueryDto.prototype, "order", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1, description: 'Фільтр за ID категорії' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 100, description: 'Мінімальна ціна' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 1000, description: 'Максимальна ціна' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'iPhone', description: 'Пошук за назвою (ILIKE)' }),
    (0, class_validator_1.IsOptional)(),
