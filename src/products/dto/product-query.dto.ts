...
export class ProductQueryDto {
  ...
  @ApiPropertyOptional({ example: 'price', description: 'Поле для сортування', enum: ['name', 'price', 'stock', 'createdAt'], default: 'createdAt' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: 1, description: 'Фільтр за ID категорії' })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  categoryId?: number;
  ...
  @ApiPropertyOptional({ example: 'iPhone', description: 'Пошук за назвою (ILIKE)' })
  @IsOptional()
  @IsString()
  search?: string;
}
